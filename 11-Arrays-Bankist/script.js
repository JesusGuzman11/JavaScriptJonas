...
// NOTE:
// This operator returns the prev value if used postfix
// but if used prefix returns the value after increment
...
console.log('dog eating an OKAY amount of food:', dogs.some(dogEatOkay));
